...
def test_environment_variable_preload():
    ...
    print("[SKIP] This test requires running in a fresh process with RTCTOOLS_PRELOAD_SOLVER_LIBS set")
    print("       Example:")
    print("           set RTCTOOLS_PRELOAD_SOLVER_LIBS=highs:C:\\path\\to\\libhighs.dll")
    print("           python -c \"import rtctools; from rtctools.solver_utils import get_solver_library_info; print(get_solver_library_info('highs'))\"")
    return None
...
def test_defensive_checks():
    ...
    import os
    from rtctools.solver_utils import get_solver_library_info, check_preload_import_order
